...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if(remoteMessage.getNotification() !=null){
            Log.d(TAG,"Cuerpo de notificacion: "+remoteMessage.getNotification().getBody());
            enviarNotificacion(remoteMessage);
        }
    }
    ...
    private void enviarNotificacion(RemoteMessage remoteMessage) {
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.O){
            ...
            @SuppressLint("WrongConstant") NotificationChannel channel = new NotificationChannel( NOTIFICATION_CHANNEL_ID, "Mi notificacion",
    ...
    private void enviarTokenToServer(final String token) {
        StringRequest stringRequest = new StringRequest( Request.Method.POST, "http://bigencode.com/ubot/notificaciones/registrarToken.php", new Response.Listener<String>() {
            @Override
